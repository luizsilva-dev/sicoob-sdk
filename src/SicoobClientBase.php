...
use LuizSilvaDev\Sicoob\Dto\TokenResponse;
use LuizSilvaDev\Sicoob\Exception\SicoobException;
...
abstract class SicoobClientBase
{
    ...
    protected function authenticatedRequest(
        ...
        if (empty($data->getContent()) || $expectedStatusCode === 204) {
            return new \LuizSilvaDev\Sicoob\Dto\CobrancaBancaria\BaixarBoletoResponse(); // mensagens vazias
        }
